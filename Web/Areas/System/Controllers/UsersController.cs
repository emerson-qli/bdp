    ...
    public class UsersController : BaseController {
        ...
        public ActionResult Index() {
            ...
            return View(new SystemUsersIndexViewModel { 
                            UserList    = new UserService().GetAllRegisteredUsers(),
        ...
        //[AuthorizeRoleBase(ApplicationElement = ApplicationElement.ElementUnknown)]
        //[HttpPost]
        public JsonResult Update(SystemUsersEditViewModel viewModel) {
            try {
        ...
        public JsonResult GetAllRoles() {
            try {
                var data = new Service.Role.RoleService().GetAllRoles(true);
        ...
        public JsonResult Get(Guid id) {
            try {
                var data = new UserService().GetAllRegisteredUsers().Where(a => a.UserId == id).FirstOrDefault();
                return Json(data, JsonRequestBehavior.AllowGet);
