...
$(function () {
    ...
    $(document).on('click', '#btn-back', function () {
        ...
        location.href = '/Setting/Approvers/';
    ...
    $(document).on('click', '#btn-new-save', function () {
        ...
        var validation = page.validate('#bdy-new', 'ApprovingAuthorityMember');

        if (validation.Valid) {
            page.save(validation.Entity, '/SaveMember', $('#btn-new-save'), 'Approving authority member added', 'Save failed', done);
        } else {
    ...
    $(document).on('click', '.btn-delete', function () {
        ...
        var id = $(this).data('id');
        showConfirm('Are you sure you want to delete this member? ', deleteApproverMember, id);
